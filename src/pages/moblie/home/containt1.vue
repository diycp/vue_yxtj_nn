     ...
     <div class="home-containt1-list" v-for="(item,i) in data">
         ...
         <div class="home-containt1-cont">
             <div class="chart">
                 ...
                 <v-piecharts :radius="radiusPie1" :colors="colorbx" :data="item"></v-piecharts>
  ...
  data:function(){
    ...
    computed:{
        ...
        backgroundyj:function(){
            return this.background+this.colorbx[0];
        },
        backgroundwj:function(){
            return this.background+this.colorbx[1];
        },
    ...
    created(){
        var _this = this;
           _this.containtDatab.then(function(rs){
            _this.data = rs;
            var _nvbl1 = [];
            rs.nvbltj.forEach(function(r,i){
                if(r.xbmc == "女"){
                    _nvbl1[0] = r;
                }else{
                    _nvbl1[1] = r;
