<template>
	<div class="chartpie">
		<canvas :id="pieid" class="pieclass" ref="pchart" :width="pwidth*1.3" :height="pheight*1.3" style="margin-left:calc(40% - 60px);transform: scale(1, 1);"></canvas>
	</div>
</template>
 <script>
 export default {
